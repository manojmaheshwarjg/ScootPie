...
function App() {
  ...
  return (
    <div suppressHydrationWarning className="min-h-screen bg-black text-white font-sans flex flex-col relative selection:bg-accent/30 selection:text-white overflow-hidden">
