...
export const AuthScreen: React.FC<AuthScreenProps> = ({ onLogin, onSkip }) => {
  ...
  const handleSkipAuth = () => {
    console.log('👤 [Auth] User chose to continue as guest');
    onSkip();
  };
  ...
  const handleSignUp = async () => {
    ...
    if (error) {
      ...
      console.log('✅ [Auth] Sign-up success — confirmation email sent to:', email);
  ...
  const renderMainOptions = () => (
    <div className="space-y-4 animate-in fade-in slide-in-from-bottom-4 duration-500">
      ...
      <button
        onClick={() => { console.log('👤 [Auth] User chose to continue as guest'); onSkip(); }}
  ...
  return (
    <div suppressHydrationWarning className="min-h-screen bg-black text-white flex flex-col items-center justify-center p-6 relative overflow-hidden">
      {/* Background Pattern */}
