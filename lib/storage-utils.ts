...
export const uploadImageToStorage = async (
    ...
    // If input is already an HTTPS URL, return it directly
    ...
    try {
        ...
        if (error) {
            if (error.message?.includes('Bucket not found')) {
                console.error(`❌ Supabase Storage Error: Bucket "${BUCKET_NAME}" not found. Please go to your Supabase Dashboard, create a PUBLIC bucket named "${BUCKET_NAME}", and set up appropriate RLS policies.`);
            } else {
