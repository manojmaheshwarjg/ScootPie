...
if (!supabaseUrl || !supabaseAnonKey) {
  console.warn("⚠️ Supabase keys missing. App running in in-memory mode. Set NEXT_PUBLIC_SUPABASE_URL or NEXT_PUBLIC_SUPABASE_PUBLISHABLE_KEY to enable persistence.");
}
